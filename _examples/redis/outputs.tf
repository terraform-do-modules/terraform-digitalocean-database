...
output "connection_pool_port" {
  value       = module.redis.connection_pool_port
...
output "connection_pool_private_uri" {
  value       = module.redis.connection_pool_private_uri
  sensitive   = true
